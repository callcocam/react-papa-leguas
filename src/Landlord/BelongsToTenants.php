...
use Callcocam\ReactPapaLeguas\Landlord\Exceptions\ModelNotFoundForTenantException;
...
trait BelongsToTenants
{
    ...
    {
        return isset($this->tenantColumns) ? $this->tenantColumns : config('tenant.default_tenant_columns', ['tenant_id']);
    }
