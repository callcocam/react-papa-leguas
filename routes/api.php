...
use Callcocam\ReactPapaLeguas\Http\Controllers\TableController;
...
Route::prefix('api')
    ...
    ->group(function () {
        ...
        Route::post('/{table}/actions/{action}/bulk-execute', [TableController::class, 'executeBulkAction'])
            ->name('api.tables.actions.bulk.execute');
